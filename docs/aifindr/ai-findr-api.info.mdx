...
>
  ...
  >
    ...
    >
      ...
      API Key for machine-to-machine authentication. Generate through Admin API endpoint /admin/api/projects/\{projectId\}/keys or the AI Findr dashboard. Recommended for server-side integrations and automated workflows.
